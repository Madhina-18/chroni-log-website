...
function Blogs() {
    ...
    useEffect(() => {
        ...
        auth.onAuthStateChanged(function (user) {
            if (user) {
                ...
                if (user.uid === "a141w3CcTBgAq4CpXcg4TmpHxLe2") {
                    setAdmin(true)
                }
                else {
    ...
    return (
        <div className="blog-section py-14">
            <h2 className="text-center text-5xl font-serif mb-14">Latest  <span className='text-[#22C6F0] '>Blogs</span> 📚</h2>
                ...
                <div className="blog-creation-form mb-8  " style={{ width: "80%", margin: "auto" }}>
                    <form onSubmit={handleNewBlogSubmit} className="flex flex-col gap-4 ">
                        <input
                            ...
                            className="p-2 border rounded border-[#22C6F0] focus:outline-none"
                            required
                        />
                        <textarea
                            ...
                            required
                        />
                        <button type="submit" className="bg-[#FF0000] text-white p-2 mb-5 rounded hover:bg-[#22C6F0]">
                            Add Blog
                        </button>
                    </form>
                </div> : ""
